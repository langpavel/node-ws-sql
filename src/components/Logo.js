...
class Logo extends React.PureComponent {
  ...
  render() {
    const { arrowColor, arrowStroke, size, width, height, ...svgRestProps } = this.props;
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width={width || size || 48} height={height || size || 48} {...svgRestProps}>
        <g className="Logo-slony" stroke="#fff" strokeWidth={2.5}>
          <path className="Logo-slony-ears" fill="#336791" strokeWidth={3} d="M67.6 2.5c-15 0-19.5 8.7-19 8.5 0 0-6.6-7.2-28.2-7.2C11 3.8 1.4 8 2 25.8c.5 7 10.4 54 22.2 40 4.3-5.3 8.2-9.4 8.2-9.4l43.6 1C88 40 93.5 24 88 12.4c-5.4-9-13.5-10-20.4-10z" />
        ...
        {arrowColor ? <path fill={arrowColor} stroke={arrowStroke} strokeWidth={3} d="M76.7 37L66 47.8l30 29.8-30 29.8L76.8 118 117 77.4z" /> : null }
      </svg>
    );
  }
}
